 ...
 */
function parseFromUrl( url, providerArg = null ) {
  ...
  provider = providerArg && !provider ? providerArg : provider;
 ...
 */
function createManga( siteUrl, outputPath, provider ) {
  const manga = parseFromUrl( siteUrl, provider );
