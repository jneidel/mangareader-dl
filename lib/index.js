    ...
    .then( html => {
      ...
      switch ( provider ) {
        ...
        case "readmng":
          ...
          break;
        case "goodmanga":
          imgSrc = $( "#manga_viewer" )[0].children[3].children[0].attribs.src;
          break;
      }
...
const getLastChapter = async ( name, provider, ajaxLib ) => {
  ...
  let url = `http://www.${provider}.${providerExtensions[provider]}/${name}`;
    ...
    .then( html => {
      ...
      switch ( provider ) {
        ...
        case "goodmanga":
          ...
          lastChapter = parseFromUrl( lastChapterUrl ).chapter;
          break;
      }
    ...
    .then( html => {
      ...
      switch ( provider ) {
        ...
        case "readmng":
          ...
          break;
        case "goodmanga":
          lastPage = $( "#manga_nav_top" )[0].children[3].children[5].children[0].data.match( /\d+/ )[0];
          break;
      }
