...
[
  ...
  ![](https://img.shields.io/badge/readmng-broken-red.svg?style=flat-square)
...
| [mangainn.net](http://www.mangainn.net/) | ![mangainn status](https://img.shields.io/badge/status-broken-red.svg?style=flat-square) | ![mangainn download speed](https://img.shields.io/badge/speed-fast-brightgreen.svg?style=flat-square) | The image hoster now requires js to be executable, which is not possible right now. See [#16](https://github.com/jneidel/mangareader-dl/issues/16) for updates. |
| [readmng.com](https://www.readmng.com/) | ![readmng status](https://img.shields.io/badge/status-broken-red.svg?style=flat-square) | ![readmng download speed](https://img.shields.io/badge/speed-medium-orange.svg?style=flat-square) | Same problem as mangainn, uses the same source. See [#17](https://github.com/jneidel/mangareader-dl/issues/17) for updates. |
